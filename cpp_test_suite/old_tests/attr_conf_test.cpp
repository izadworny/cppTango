...
void check_description(Tango::DeviceProxy &d, Tango::DeviceProxy &, string &, const char *, const char *, const char *,
                       const char *);
void check_min_value(Tango::DeviceProxy &d, Tango::DeviceProxy &, string &, const char *, const char *, const char *,
                     const char *);
void check_ev_period_value(Tango::DeviceProxy &d, Tango::DeviceProxy &, string &, const char *, const char *,
                           const char *, const char *);
void check_rel_change_value(Tango::DeviceProxy &d, Tango::DeviceProxy &, string &, const char *, const char *,
                            const char *, const char *);
void check_delta_val_value(Tango::DeviceProxy &d, Tango::DeviceProxy &, string &, const char *, const char *,
                           const char *, const char *);
...
void check_description(Tango::DeviceProxy &dev, Tango::DeviceProxy &admin_dev, string &att, const char *dev_desc,
                       const char *class_desc, const char *user_desc, const char *lib_desc)
{
  // Set-up
...
void check_min_value(Tango::DeviceProxy &dev, Tango::DeviceProxy &admin_dev, string &att, const char *dev_desc,
                     const char *class_desc, const char *user_desc, const char *lib_desc)
{
  // Set-up
...
void check_ev_period_value(Tango::DeviceProxy &dev, Tango::DeviceProxy &admin_dev, string &att, const char *dev_desc,
                           const char *class_desc, const char *user_desc, const char *lib_desc)
{
  // Set-up
...
void check_rel_change_value(Tango::DeviceProxy &dev, Tango::DeviceProxy &admin_dev, string &att, const char *dev_desc,
                            const char *class_desc, const char *user_desc, const char *lib_desc)
{
  // Set-up
...
void check_delta_val_value(Tango::DeviceProxy &dev, Tango::DeviceProxy &admin_dev, string &att, const char *dev_desc,
                           const char *class_desc, const char *user_desc, const char *lib_desc)
{
  // Set-up
