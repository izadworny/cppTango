...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    cout << "   Read command history for one externally triggered polled "
            "command --> OK"
         << endl;
    ...
    cout << "   Read attribute history for one attribute with polling buffer "
            "externally filled (including R/W "
            "attribute) --> OK"
         << endl;
    ...
    cout << "   Read attribute history for one DevEncoded attribute with "
            "polling buffer externally filled --> OK"
         << endl;
#endif
  }
  ...
  try
  {
    ...
    cout << "   Read attribute history for one externally triggered polled "
            "attribute --> OK"
         << endl;
    ...
    cout << "   Read command history for one command with polling buffer "
            "externally filled --> OK"
         << endl;
  }
  catch(Tango::DevFailed &e)
  {
