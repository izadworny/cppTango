...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    //
    // Remove the dynamic command -> Should generate a device interface change
    // event
    //
    ...
    cout << "   Dev. interface change event after add/remove dynamic command "
            "--> OK"
         << std::endl;
    ...
    cout << "   Dev. interface change event after Init or DevRestart command "
            "--> OK"
         << std::endl;
