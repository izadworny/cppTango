...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    cout << "   Two CallBacks executed when attribute throw exception (only "
            "once) --> OK"
         << std::endl;
    ...
    cout << "   Two CallBacks executed after a try to subscribe to one "
            "attribute with a NULL callback --> OK"
         << std::endl;
    ...
    cout << "   Two different CallBacks executed for positive absolute delta "
            "--> OK"
         << std::endl;
    ...
    cout << "   Two different CallBacks executed for negative absolute delta "
            "--> OK"
         << std::endl;
    ...
    cout << "   Event unsubscription within the callback with two other "
            "subscribers --> OK"
         << std::endl;
