...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    cout << "   CallBack executed when attribute throw exception every 1000 mS "
            "--> OK"
         << std::endl;
    ...
    /*		std::vector<short> data_in_out(2);
                    ...
                    cout << "   Receiving out_of_sync exception --> OK" <<
    std::endl;
    ...
    //
                    ...
                    cout << "   Back to periodic event after out_of_sync
    exception --> OK" << std::endl;*/
    ...
    //
    // subscribe again to test subsription in CB an dpoll attribute on second
    // device
    //
