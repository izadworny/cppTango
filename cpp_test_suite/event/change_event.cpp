...
{
  // TODO: FIXME: This test is temporarily disabled due to failures on
  ...
  try
  {
    ...
    //
    // Check that the event is still received event after a try to subscribe
    ...
    cout << "   CallBack executed after a try to subscribe to one attribute "
            "with a NULL callback --> OK"
         << std::endl;
