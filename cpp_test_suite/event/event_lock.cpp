...
[EventCallback::push_event] attr-name:
tango://taco10.taco.frm2:10000/sys/tg_test/1/long_scalar
...
[main] new locking status: Device sys/tg_test/1 is locked by CPP or Python
client with PID 17831 from host giop:tcp:[::ffff:172.25.2.10]:18156

[main] still alive. Waiting for a long_scalar event  [exiting after 3 trials]
... [EventCallback::push_event] entering  ... [EventCallback::push_event]
attr-name: sys/tg_test/1/long_scalar [EventCallback::push_event] event
type=change [EventCallback::push_event] err=0 [EventCallback::push_event] got:
long_scalar=100 [EventCallback::push_event] leaving.

[main] still alive. Waiting for a long_scalar event  [exiting after 3 trials]
... [EventCallback::push_event] entering  ... [EventCallback::push_event]
attr-name: sys/tg_test/1/long_scalar [EventCallback::push_event] event
type=change [EventCallback::push_event] err=0 [EventCallback::push_event] got:
long_scalar=145 [EventCallback::push_event] leaving.

[main] still alive. Waiting for a long_scalar event  [exiting after 3 trials]
... [EventCallback::push_event] entering  ... [EventCallback::push_event]
attr-name: sys/tg_test/1/long_scalar [EventCallback::push_event] event
type=change [EventCallback::push_event] err=0 [EventCallback::push_event] got:
long_scalar=67 [EventCallback::push_event] leaving.
...
*** glibc detected *** ExitCrashProblemClient: double free or corruption
(fasttop): 0x08074b38 ***
======= Backtrace: =========
...
======= Memory map: ========
08048000-0804b000 r-xp 00000000 08:03 1188175
/home/projekte/tango/Tests/ExitCrashProblem/ExitCrashProblemClient
0804b000-0804c000 r--p 00002000 08:03 1188175
/home/projekte/tango/Tests/ExitCrashProblem/ExitCrashProblemClient
0804c000-0804d000 rw-p 00003000 08:03 1188175
/home/projekte/tango/Tests/ExitCrashProblem/ExitCrashProblemClient
...
b758e000-b7706000 r-xp 00000000 08:03 1638830
/home/local/omniOrb/lib/libCOS4.so.1.3 b7706000-b7734000 r--p 00178000 08:03
1638830    /home/local/omniOrb/lib/libCAbgebrochen
