...
public:
  ...
  virtual ~SUITE_NAME()
  {
    ...
    // clean up in case test suite terminates before timeout is restored to
    // defaults
  ...
  void test_set_get_properties(void)
  {
    ...
    gettimeofday(&start,NULL);
                    TS_ASSERT_THROWS_NOTHING(dout =
    device1->command_inout("SetGetProperties")); TS_ASSERT_THROWS_NOTHING(dout
    >> props); gettimeofday(&stop,NULL); double elapsed = (double)(stop.tv_sec -
    start.tv_sec) + (double)(stop.tv_usec - start.tv_usec) / 1000000.0; cout <<
    "required time for command SetGetProperties = " << elapsed << endl;

    //		cout << "## prop length = " << (*props).length() << endl;

                    TS_ASSERT_EQUALS((*props).length(), 420);
                    size_t i = 0;
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "Double_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_standard_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_display_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "0"); i++;
    ...
    "Test_standard_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_display_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "Float_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    ...
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "Long_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    ...
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "Long64_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    ...
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "Short_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    ...
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "UChar_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    ...
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "ULong_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    ...
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "ULong64_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    ...
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "UShort_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    ...
    "Test_format"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "1"); i++;
                    ...
                    TS_ASSERT_EQUALS(string((*props)[i].in()), "Encoded_attr");
    i++; TS_ASSERT_EQUALS(string((*props)[i].in()), "Test_label"); i++;
                    TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_description"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
    "Test_unit"); i++; TS_ASSERT_EQUALS(string((*props)[i].in()),
...
#define assert_dev_state(expected) __assert_dev_state(expected, TANGO_FILE_AND_LINE)
  ...
  // Verifies that device state is set correctly when alarm is configured for an
  // attribute but no value is provided for this attribute in user callback
...
#undef assert_dev_state
  ...
  /*
   * Tests for reading multiple attributes in a single network call where the
   * last attribute has a valid quality but the read callback does not set any
   * value.
   *
  ...
  void test_multiple_attributes_read_in_one_call_last_has_no_data_dev_impl_3()
  {
    ...
    TS_ASSERT_THROWS_NOTHING(
        result = std::unique_ptr<std::vector<Tango::DeviceAttribute>>(device1->read_attributes(attribute_names_value)));
    ...
    TS_ASSERT_THROWS_ASSERT((*result)[1] >> short_value, Tango::DevFailed & e,
  ...
  void test_multiple_attributes_read_in_one_call_last_has_no_data_dev_impl_1_2()
  {
    ...
    TS_ASSERT_THROWS_ASSERT(result = device1->get_device()->read_attributes(attribute_names), Tango::DevFailed & e,
                            TS_ASSERT(std::string(e.errors[0].reason.in()) == API_AttrValueNotSet));
  }
};
