...
public:
  ...
  void test_reading_pipe_with_error_cases(void)
  {
    ...
    TS_ASSERT_THROWS_ASSERT(pipe_data >> dl >> v_db >> v_us >> v_sta >> dl_extra;
    ...
    TS_ASSERT_THROWS_ASSERT(pipe_data >> dl >> dl_extra;
                            , Tango::DevFailed & e,
    ...
    TS_ASSERT_THROWS_ASSERT(pipe_data >> dl >> dl;
                            , Tango::DevFailed & e,
    ...
    TS_ASSERT_THROWS_ASSERT(pipe_data = device1->read_pipe("rpipe");
                            , Tango::DevFailed & e,
    ...
    TS_ASSERT_THROWS_ASSERT(pipe_data = device1->read_pipe("pi");
    ...
    TS_ASSERT_THROWS_ASSERT(pipe_data["SecondDE"] >> de_v_db;
                            , Tango::DevFailed & e,
                            TS_ASSERT_EQUALS(string(e.errors[0].reason.in()), API_NotSupportedFeature);
                            TS_ASSERT_EQUALS(e.errors[0].severity, Tango::ERR));
  }
  ...
  void test_writing_pipe_with_error(void)
  {
    ...
    TS_ASSERT_THROWS_ASSERT(device1->write_pipe(dp);
                            , Tango::DevFailed & e,
                            TS_ASSERT_EQUALS(string(e.errors[0].reason.in()), API_PipeNoDataElement);
                            TS_ASSERT_EQUALS(e.errors[0].severity, Tango::ERR));
