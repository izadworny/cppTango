...
public:
      ...
      : device1_instance_name{"test"} // TODO pass via cl
  {
    ...
    // localparam =
    // CxxTest::TangoPrinter::get_param_loc("localparam","description of what
    // localparam is");
    ...
    // CxxTest::TangoPrinter::get_param_opt("loop"); // loop parameter is then
    // managed by the CXX framework itself or
  ...
  virtual ~SUITE_NAME()
  {
    ...
    // clean up in case test suite terminates before Server_Killed is restored
    // to defaults
  ...
  void test_TestWriteAttributeAsynchAfterReconnection()
  {
    ...
    try
    {
      ...
      cout << "   Asynchronous write_attribute in polling mode after "
              "reconnection--> OK"
           << endl;
    }
    catch(const Tango::DevFailed &e)
