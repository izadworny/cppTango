...
public:
  ...
  virtual ~SUITE_NAME()
  {
    ...
    // clean up in case test suite terminates before my_restore_point is
  ...
  void test_TestName()
  {
    // if your code modifies the default (device) configuration, append the
    // following line straight after
    ...
    // if the test suite fails here, thanks to the restore point, the test suite
    // TearDown method will restore the defaults after you set back the default
    // configuration, append the following line
