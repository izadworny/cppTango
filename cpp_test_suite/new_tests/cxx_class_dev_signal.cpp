...
public:
  ...
  virtual ~SUITE_NAME()
  {
    ...
    // clean up in case test suite terminates before logging level is restored
    // to defaults
    ...
    // clean up in case test suite terminates before logging targets are
    ...
    // clean up in case test suite terminates before newly registered signals
    // are unregistered
    ...
    // clean up in case test suite terminates before newly registered class
    // signals are unregistered
  ...
  void test_signal_handling(void)
  {
    ...
    // unregister signal on class and device level
    din << sig_num;
