...
public:
  ...
  void test_DevFailed_from_write_attr_hardware(void)
  {
    ...
    TS_ASSERT_THROWS_ASSERT(
        device->write_attributes(attr_in), Tango::NamedDevFailedList & e,
        ...
        TS_ASSERT_EQUALS(string(e.err_list[1].name), att2_name); TS_ASSERT_EQUALS(e.err_list[1].idx_in_call, 1);
        ...
        TS_ASSERT_EQUALS(string(e.err_list[2].name), att3_name); TS_ASSERT_EQUALS(e.err_list[2].idx_in_call, 2);
