...
public:
  ...
  // Test synchronous command with forwarding (default) and several DeviceData
  // arguments
  ...
  // Test asynchronous command with forwarding (default) and several DeviceData
  // arguments
  ...
  // Test synchronous command with forwarding (default) and wrong number of
  // arguments
  ...
  // Test synchronous command throwing an exception with enable exception mode
  // ON
