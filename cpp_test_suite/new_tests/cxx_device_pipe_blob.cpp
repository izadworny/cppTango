...
class DevicePipeBlobTestSuite: public CxxTest::TestSuite
{
    ...
    public:
        ...
        void test_operator_insertion()
        {
            ...
            Tango::DevicePipeBlob pipe("test");
            
            Tango::DevicePipeBlob test1("test1");
            Tango::DevicePipeBlob test2("test2");
            Tango::DevicePipeBlob test3("test3");
            ...
            Tango::DevString datum = Tango::string_dup(test_data);
