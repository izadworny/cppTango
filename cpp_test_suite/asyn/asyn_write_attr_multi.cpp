...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    cout << "   Asynchronous write_attributes in blocking mode with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device timeout with blocking write_attributes_reply with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device exception with blocking write_attributes_reply with "
            "call timeout --> OK"
         << std::endl;
