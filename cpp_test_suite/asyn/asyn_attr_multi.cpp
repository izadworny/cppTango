...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    cout << "   Asynchronous read_attributes in blocking mode with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device timeout with blocking read_attributes_reply with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device exception with blocking read_attributes_reply with call "
            "timeout --> OK"
         << std::endl;
