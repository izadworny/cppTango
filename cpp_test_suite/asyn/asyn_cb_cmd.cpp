...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    cout << "   Aynchronous command_inout in blocking mode without timeout --> "
            "OK"
         << std::endl;
    ...
    cout << "   Device timeout with blocking get_asynch_replies without "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device exception with blocking get_asynch_replies without "
            "timeout --> OK"
         << std::endl;
  }
