...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    cout << "   Asynchronous write_attribute in polling mode --> OK" << std::endl;
    ...
    cout << "   Asynchronous write_attribute (DevEncoded data type) in polling "
            "mode --> OK"
         << std::endl;
#endif
    ...
    cout << "   Asynchronous write_attribute in blocking mode with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Asynchronous write_attribute in blocking mode --> OK" << std::endl;
    ...
    cout << "   Device timeout exception with non blocking "
            "write_attribute_reply --> OK"
         << std::endl;

    // Write an attribute to check timeout with polling and blocking with
    // timeout
    ...
    cout << "   Device timeout with blocking write_attribute_reply with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device timeout with blocking write_attribute_reply --> OK" << std::endl;
    ...
    cout << "   Device exception with non blocking write_attribute_reply --> OK" << std::endl;
    ...
    cout << "   Device exception with blocking write_attribute_reply with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device exception with blocking write_attribute_reply --> OK" << std::endl;
  }
