...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    cout << "   Asynchronous read_attribute in polling mode --> OK" << std::endl;
    ...
    while(finish == false)
    {
      ...
      {
        received = device->read_attribute_reply(id);
        coutv << "Attribute result arrived" << std::endl;
    ...
    cout << "   Asynchronous read_attribute (DevEncoded data type) in polling "
            "mode --> OK"
         << std::endl;
#endif
    ...
    cout << "   Asynchronous read_attribute in blocking mode with call timeout "
            "--> OK"
         << std::endl;
    ...
    *received >> l;
    ...
    cout << "   Asynchronous read_attribute in blocking mode --> OK" << std::endl;
    ...
    cout << "   Device timeout exception with non blocking command_inout_reply "
            "--> OK"
         << std::endl;
    ...
    cout << "   Device timeout with blocking command_inout_reply with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device timeout with blocking command_inout_reply --> OK" << std::endl;
    ...
    cout << "   Device exception with non blocking read_attribute_reply --> OK" << std::endl;
    ...
    cout << "   Device exception with blocking read_attribute_reply with call "
            "timeout --> OK"
         << std::endl;
    ...
    cout << "   Device exception with blocking read_attribute_reply --> OK" << std::endl;
  }
