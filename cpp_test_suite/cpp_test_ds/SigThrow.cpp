...
IOThrow::IOThrow(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                 const char *out_desc)
...
CORBA::Any *IOThrow::execute(TANGO_UNUSED(Tango::DeviceImpl *device), const CORBA::Any &in_any)
{
  ...
  Tango::Except::throw_exception((const char *) (theException->svalue)[0], (const char *) "This is a test ",
                                 (const char *) "IOThrow::execute()", (Tango::ErrSeverity) severity);
...
IOExcept::IOExcept(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                   const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
CORBA::Any *IOExcept::execute(TANGO_UNUSED(Tango::DeviceImpl *device), TANGO_UNUSED(const CORBA::Any &in_any))
{
  ...
  Tango::Except::throw_exception((const char *) API_ThrowException, (const char *) "This is a test ",
...
IOReThrow::IOReThrow(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                     const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
  ...
  catch(Tango::DevFailed &e)
  {
    if(nb_except > 2)
    {
      ...
      for(int i = 0; i < nb_except - 2; i++)
      {
        try
        {
          Tango::Except::re_throw_exception(e, (const char *) (theException->svalue)[ind],
                                            (const char *) "This is a test ", (const char *) "IOReThrow::execute()",
    ...
    Tango::Except::re_throw_exception(e, (const char *) (theException->svalue)[nb_except - 1],
                                      (const char *) "This is a test ", (const char *) "IOReThrow::execute()",
...
IORegClassSig::IORegClassSig(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                             const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IORegSig::IORegSig(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                   const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IORegSigOwn::IORegSigOwn(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                         const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOUnregClassSig::IOUnregClassSig(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                 const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOUnregSig::IOUnregSig(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                       const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
