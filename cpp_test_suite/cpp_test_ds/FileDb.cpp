...
void DevTest::FileDb()
{
  cout << "[DevTest::FileDb] received" << std::endl;
  ...
  cout << "   DbClass object created --> OK" << std::endl;
  ...
  cout << "   Property not defined --> OK" << std::endl;
  db_dat_get.clear();
  ...
  cout << "   Put class property --> OK" << std::endl;
  ...
  cout << "   Get class property --> OK" << std::endl;
  db_dat_get.clear();
  ...
  cout << "   Delete class property --> OK" << std::endl;
  ...
  cout << std::endl;
  cout << "   Device property not defined --> OK" << std::endl;
  dev_dat_get.clear();
  ...
  cout << "   Put device property --> OK" << std::endl;
  ...
  cout << "   Get device property --> OK" << std::endl;
  dev_dat_get.clear();
  ...
  cout << "   Delete device property --> OK" << std::endl;
  ...
  cout << "   Class attribute property not defined --> OK" << std::endl;
  cl_att_get.clear();
  ...
  cout << "   Put class attribute property --> OK" << std::endl;
  ...
  cout << "   Get class attribute property --> OK" << std::endl;
  cl_att_get.clear();
  ...
  cout << "   Delete class attribute property --> OK" << std::endl;
  ...
  cout << "   Device attribute property not defined --> OK" << std::endl;
  dev_att_get.clear();
  ...
  cout << "   Put device attribute property --> OK" << std::endl;
  ...
  dev_att_get[0] >> pr;
  assert(pr == "You look nice");
  cout << "   Get device attribute property --> OK" << std::endl;
  dev_att_get.clear();
  ...
  cout << "   Delete device attribute property --> OK" << std::endl;
}
