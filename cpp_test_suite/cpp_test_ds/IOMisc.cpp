...
IODServDevice::IODServDevice(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                             const char *out_desc)
...
IODevByName::IODevByName(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                         const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
IODevListByClass::IODevListByClass(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                   const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
IOSleep::IOSleep(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                 const char *out_desc)
...
IOState::IOState(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                 const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOStartPoll::IOStartPoll(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                         const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOShortSleep::IOShortSleep(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                           const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOSleepExcept::IOSleepExcept(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                             const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOExit::IOExit(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc, const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOTrigPoll::IOTrigPoll(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                       const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOAttrTrigPoll::IOAttrTrigPoll(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                               const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOInitWAttr::IOInitWAttr(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                         const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOAttrThrowEx::IOAttrThrowEx(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                             const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
CORBA::Any *IOAttrThrowEx::execute(Tango::DeviceImpl *device, const CORBA::Any &in_any)
{
  ...
  bool &flag = (flag_disc == 0)   ? dev.Short_attr_except
...
IOAddOneElt::IOAddOneElt(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                         const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IORemoveOneElt::IORemoveOneElt(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                               const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOIncValue::IOIncValue(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                       const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IODecValue::IODecValue(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                       const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOChangeQuality::IOChangeQuality(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                 const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOPushEvent::IOPushEvent(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                         const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOPushDevEncodedEvent::IOPushDevEncodedEvent(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
...
IOSubscribeEvent::IOSubscribeEvent(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                   const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOUnSubscribeEvent::IOUnSubscribeEvent(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                       const char *in_desc, const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOGetCbExecuted::IOGetCbExecuted(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                 const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
{
  cout << "[IOGetCbExecuted::execute] received, returned value = " << (static_cast<DevTest *>(device))->cb.cb_executed
       << std::endl;
...
IOFillPollBuffAttr::IOFillPollBuffAttr(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                       const char *in_desc, const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOFillPollBuffEncodedAttr::IOFillPollBuffEncodedAttr(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                                     const char *in_desc, const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}

bool IOFillPollBuffEncodedAttr::is_allowed(TANGO_UNUSED(Tango::DeviceImpl *device),
...
IOFillPollBuffCmd::IOFillPollBuffCmd(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                     const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
FileDbCmd::FileDbCmd(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                     const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
GetLongSize::GetLongSize(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                         const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
ChangeEncodedFormat::ChangeEncodedFormat(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                         const char *in_desc, const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
ChangeEncodedData::ChangeEncodedData(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                     const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
PushDataReady::PushDataReady(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                             const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
IOSetWAttrLimit::IOSetWAttrLimit(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                 const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
void *AcquisitionThread::run_undetached(TANGO_UNUSED(void *arg))
{
  ...
  // the second device on the list is selected to be the sub device, so the list
  // has to comprise of 2 or more elements
  if(n > 1)
  {
    // bubble sort
    do
...
SubDeviceTst::SubDeviceTst(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                           const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
CORBA::Any *SubDeviceTst::execute(TANGO_UNUSED(Tango::DeviceImpl *device), TANGO_UNUSED(const CORBA::Any &in_any))
{
  ...
  try
  {
    ...
    size_t n = dev_list_sorted.size();
    // the third device on the list is selected to be the sub device, so the
    // list has to comprise of 3 or more elements
    if(n > 2)
    {
      // bubble sort
      do
...
PollingPoolTst::PollingPoolTst(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                               const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
PollingInDeviceTst::PollingInDeviceTst(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                       const char *in_desc, const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
ReynaldPollThread::ReynaldPollThread(Tango::DeviceImpl *_d)
    : dev(_d)
{
  start();
}
...
SophisPollInDeviceTst::SophisPollInDeviceTst(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                             const char *in_desc, const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
GetPollMess::GetPollMess(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                         const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
WriteAttrHardwareThrow::WriteAttrHardwareThrow(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                               const char *in_desc, const char *out_desc)
    : Tango::Command(name, in, out, in_desc, out_desc)
{
}
...
SetGetAlarms::SetGetAlarms(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                           const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
{
  //
  // Sets alarm values using functions executed on the server side. Reads the
  // previously set values with functions called also on the server side and
  // creates a vector of string representations of the read values. This vector
  // is returned in the form of DevVarStringArray *.
  //
  ...
  try
  {
    ...
    try
    {
      ...
      Tango::DevDouble db, db_min_alarm = -999.99, db_min_warning = -888.88, db_max_warning = 888.88,
                           db_max_alarm = 999.99;
    ...
    try
    {
      ...
      Tango::DevFloat fl, fl_min_alarm = -777.77, fl_min_warning = -666.66, fl_max_warning = 666.66,
                          fl_max_alarm = 777.77;
    ...
    try
    {
      ...
      Tango::DevLong64 lg64, lg64_min_alarm = -90000, lg64_min_warning = -80000, lg64_max_warning = 80000,
                             lg64_max_alarm = 90000;
    ...
    try
    {
      ...
      Tango::DevULong64 ulg64, ulg64_min_alarm = 1, ulg64_min_warning = 2, ulg64_max_warning = 77777777,
                               ulg64_max_alarm = 88888888;
...
SetGetRanges::SetGetRanges(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                           const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
{
  //
  // Sets ranges values using functions executed on the server side. Reads the
  // previously set values with functions called also on the server side and
  // creates a vector of string representations of the read values. This vector
  // is returned in the form of DevVarStringArray *.
  //
...
SetGetProperties::SetGetProperties(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                                   const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
CORBA::Any *SetGetProperties::execute(Tango::DeviceImpl *device, TANGO_UNUSED(const CORBA::Any &in_any))
{
  ...
  //
  // Sets properties using functions executed on the server side. Reads the
  // previously set values with functions called also on the server side and
  // creates a vector of string representations of the read values. This vector
  // is returned in the form of DevVarStringArray *.
  //
  ...
  try
  {
    ...
    //		{
    //			Tango::MultiAttrProp<Tango::DevDouble> multi_prop, multi_prop_get;
    //			Tango::WAttribute &wattr =
    // attributes->get_w_attr_by_name("UChar_attr_w");
    //
    //			attr.get_properties(conf);
    //			attr_ptr = &attr;
    //
...
SetEnumLabels::SetEnumLabels(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                             const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
AddEnumLabel::AddEnumLabel(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                           const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
ForbiddenEnumValue::ForbiddenEnumValue(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                       const char *in_desc, const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
SetPipeOutput::SetPipeOutput(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                             const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
PushPipeEvent::PushPipeEvent(const char *name, Tango::CmdArgType in, Tango::CmdArgType out, const char *in_desc,
                             const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
...
PushStateStatusChangeEvent::PushStateStatusChangeEvent(const char *name, Tango::CmdArgType in, Tango::CmdArgType out,
                                                       const char *in_desc, const char *out_desc)
    : Command(name, in, out, in_desc, out_desc)
{
}
