...
bool FileAppender::is_valid(void) const { return (_fd < 0) ? false : true; }
...
bool FileAppender::get_append(void) const { return (_flags & O_TRUNC) == 0; }

void FileAppender::set_mode(mode_t mode) { _mode = mode; }

mode_t FileAppender::get_mode(void) const { return _mode; }
