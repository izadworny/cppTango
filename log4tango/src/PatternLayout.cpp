...
struct StringLiteralComponent : public PatternLayout::PatternComponent
{
  ...
  virtual void append(std::ostringstream &out, const LoggingEvent & /*event*/) { out << _literal; }
...
{
  virtual void append(std::ostringstream &out, const LoggingEvent &event) { out << event.message; }
};

struct LevelComponent : public PatternLayout::PatternComponent
{
  virtual void append(std::ostringstream &out, const LoggingEvent &event) { out << Level::get_name(event.level); }
};

struct ThreadNameComponent : public PatternLayout::PatternComponent
{
  virtual void append(std::ostringstream &out, const LoggingEvent &event) { out << event.thread_name; }
};

struct ThreadIdComponent : public PatternLayout::PatternComponent
{
  virtual void append(std::ostringstream &out, const LoggingEvent &event) { out << event.thread_id; }
};

struct ProcessorTimeComponent : public PatternLayout::PatternComponent
{
  virtual void append(std::ostringstream &out, const LoggingEvent & /*event*/) { out << ::clock(); }
};

struct FilePathComponent : public PatternLayout::PatternComponent
{
  virtual void append(std::ostringstream &out, const LoggingEvent &event) { out << event.file_path; }
};

struct LineNumberComponent : public PatternLayout::PatternComponent
{
  virtual void append(std::ostringstream &out, const LoggingEvent &event) { out << event.line_number; }
};
...
struct TimeStampComponent : public PatternLayout::PatternComponent
{
  ...
  virtual void append(std::ostringstream &out, const LoggingEvent &event)
  {
    ...
    if(_printFraction)
    {
      ...
      formatStream << _timeFormat1 << std::setw(precision) << std::setfill('0') << fraction.count() << _timeFormat2;
...
struct FormatModifierComponent : public PatternLayout::PatternComponent
{
  ...
  virtual ~FormatModifierComponent() { delete _component; }
...
PatternLayout::PatternLayout() { set_conversion_pattern(BASIC_CONVERSION_PATTERN); }

PatternLayout::~PatternLayout() { clear_conversion_pattern(); }
...
std::string PatternLayout::get_conversion_pattern() const { return _conversionPattern; }
