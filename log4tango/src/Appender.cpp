...
bool Appender::is_valid(void) const { return true; }

bool Appender::reopen(void) { return true; }
...
#if APPENDERS_HAVE_LEVEL_THRESHOLD
void Appender::set_level(Level::Value level) { _level = level; }

Level::Value Appender::get_level(void) const { return _level; }
...
Filter *Appender::get_filter(void) { return _filter; }
