...
RollingFileAppender::RollingFileAppender(const std::string &name, const std::string &file_name, size_t max_fs,
                                         unsigned int max_bi, bool append, mode_t mode)
...
void RollingFileAppender::set_max_backup_index(unsigned int max_bi) { _max_backup_index = max_bi; }

unsigned int RollingFileAppender::get_max_backup_index() const { return _max_backup_index; }

void RollingFileAppender::set_maximum_file_size(size_t max_fs) { _max_file_size = max_fs; }

size_t RollingFileAppender::get_max_file_size() const { return _max_file_size; }
