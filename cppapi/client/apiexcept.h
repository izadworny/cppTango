...
public:
  ...
  long idx_in_call;       ///< Index in the write_attributes method parameter vector
                          ///< of the attribute which failed.
  DevErrorList err_stack; ///< The error stack

  /// @privatesection

  NamedDevFailed(const DevErrorList &err, const std::string &na, long idx)
      : name(na),
        idx_in_call(idx),
        err_stack(err)
  {
...
public:
   ...
   * call.
   *
   * @return The number of attribute(s) which fail during the write_attribute
   * call
   */
  ...
  std::vector<NamedDevFailed> err_list; ///< There is one element in this vector for each attribute
                                        ///< which failed during its writing.
  ...
  public:                                                                                                             \
    ...
    {                                                                                                                 \
      ...
      throw Tango::E(errors);                                                                                         \
                                                                                                                      ...
                                                                                                                      \
    static inline void re_throw_exception(CORBA::SystemException &cex, const std::string &reason,                     \
    ...
    {                                                                                                                 \
      ...
      throw Tango::E(errors);                                                                                         \
                                                                                                                      ...
                                                                                                                      \
    static inline void re_throw_exception(CORBA::SystemException &cex, char *reason, char *desc, const char *origin,  \
                                          Tango::ErrSeverity sever = Tango::ERR)                                      \
    {                                                                                                                 \
      Tango::DevErrorList errors(2);                                                                                  \
      errors.length(2);                                                                                               \
    ...
    static inline void re_throw_exception(CORBA::SystemException &cex, const char *reason, const std::string &desc,   \
    ...
    {                                                                                                                 \
      ...
      throw Tango::E(errors);                                                                                         \
                                                                                                                      ...
                                                                                                                      \
    static inline void re_throw_exception(CORBA::SystemException &cex, const char *reason, char *desc,                \
                                          const char *origin, Tango::ErrSeverity sever = Tango::ERR)                  \
    {                                                                                                                 \
      Tango::DevErrorList errors(2);                                                                                  \
      errors.length(2);                                                                                               \
      ...
      throw Tango::E(errors);                                                                                         \
                                                                                                                      ...
                                                                                                                      \
    static inline void re_throw_exception(Tango::E &ex, const char *reason, char *desc, const char *origin,           \
                                          Tango::ErrSeverity sever = Tango::ERR)                                      \
    {                                                                                                                 \
      ...
      throw ex;                                                                                                       \
                                                                                                                      ...
                                                                                                                      \
    static inline void re_throw_exception(Tango::E &ex, const char *reason, const std::string &desc,                  \
                                          const char *origin, Tango::ErrSeverity sever = Tango::ERR)                  \
    {                                                                                                                 \
      long nb_err = ex.errors.length();                                                                               \
      ex.errors.length(nb_err + 1);                                                                                   \
    ...
    static inline void re_throw_exception(Tango::DevFailed &ex, const char *reason, char *desc, const char *origin,   \
                                          Tango::ErrSeverity sever = Tango::ERR)                                      \
    {                                                                                                                 \
      long nb_err = ex.errors.length();                                                                               \
      ex.errors.length(nb_err + 1);                                                                                   \
      ...
      throw ex;                                                                                                       \
                                                                                                                      ...
                                                                                                                      \
    static inline void re_throw_exception(Tango::DevFailed &ex, const char *reason, const std::string &desc,          \
                                          const char *origin, Tango::ErrSeverity sever = Tango::ERR)                  \
    {                                                                                                                 \
      long nb_err = ex.errors.length();                                                                               \
      ex.errors.length(nb_err + 1);                                                                                   \
    ...
    static inline void re_throw_exception(Tango::DevFailed &ex, const char *reason, const char *desc,                 \
                                          const char *origin, Tango::ErrSeverity sever = Tango::ERR)                  \
    {                                                                                                                 \
      long nb_err = ex.errors.length();                                                                               \
      ex.errors.length(nb_err + 1);                                                                                   \
      ...
      throw ex;                                                                                                       \
                                                                                                                      ...
                                                                                                                      \
    static inline void re_throw_exception(char *CORBA_error_desc, const char *reason, char *desc, const char *origin, \
                                          Tango::ErrSeverity sever = Tango::ERR)                                      \
    {                                                                                                                 \
      Tango::DevErrorList errors(2);                                                                                  \
      errors.length(2);                                                                                               \
      ...
      throw Tango::E(errors);                                                                                         \
                                                                                                                      ...
                                                                                                                      \
    static inline void re_throw_exception(char *CORBA_error_desc, const char *reason, const std::string &desc,        \
                                          const char *origin, Tango::ErrSeverity sever = Tango::ERR)                  \
    {                                                                                                                 \
      Tango::DevErrorList errors(2);                                                                                  \
      errors.length(2);                                                                                               \
...
#define TRANSIENT_NOT_EXIST_EXCEPT(E, CLASS, NAME, OBJ)                                                               \
  ...
  {                                                                                                                   \
    ...
    {                                                                                                                 \
      ...
      ApiCommExcept::re_throw_exception(E, (const char *) API_DeviceTimedOut, desc.str(), ori.str());                 \
    }                                                                                                                 \
  }                                                                                                                   \
                                                                                                                      \
  ...
  ctr++;                                                                                                              \
                                                                                                                      \
  if((OBJ->tr_reco == false) || ((ctr == 2) && (OBJ->tr_reco == true)))                                               \
  {                                                                                                                   \
    TangoSys_OMemStream desc;                                                                                         \
    ...
    TangoSys_OMemStream ori;                                                                                          \
    ori << CLASS << ":" << NAME << std::ends;                                                                         \
    ApiCommExcept::re_throw_exception(E, (const char *) API_CommunicationFailed, desc.str(), ori.str());              \
  }
...
#define TRANSIENT_NOT_EXIST_EXCEPT_CMD(E)                                                                             \
  ...
  {                                                                                                                   \
    ...
    {                                                                                                                 \
      ...
      ApiCommExcept::re_throw_exception(E, (const char *) API_DeviceTimedOut, desc.str(),                             \
  ...
  {                                                                                                                   \
    ...
    desc << "Device " << dev_name()                                                                                   \
         << " has lost your lock(s) (server re-start?) while executing "                                              \
            "command "                                                                                                \
         << command << std::ends;                                                                                     \
    DeviceUnlockedExcept::re_throw_exception(E, (const char *) DEVICE_UNLOCKED_REASON, desc.str(),                    \
                                             (const char *) "Connection::command_inout()");                           \
  }                                                                                                                   \
  ctr++;                                                                                                              \
                                                                                                                      \
  if((tr_reco == false) || ((ctr == 2) && (tr_reco == true)))                                                         \
  {                                                                                                                   \
    TangoSys_OMemStream desc;                                                                                         \
    desc << "Failed to execute command_inout on device " << dev_name();                                               \
    desc << ", command " << command << std::ends;                                                                     \
    ApiCommExcept::re_throw_exception(E, (const char *) API_CommunicationFailed, desc.str(),                          \
                                      (const char *) "Connection::command_inout()");                                  \
  }
