...
//
// description:
//		constructor for the DbServerData class. This class data stored in the
// database related to a device
// server 		process. It allows easy insert/remove of one device server process
...
//
// description:
//		Store all the data related to the device server process in the database
// specified by the input arg.
//
// argument:
// 		in :
...
//
// description:
//		Check if any of the device server process device(s) is already defined in
// the database specified by the 		tango host given as input arg
//
// argument:
// 		in :
...
//
// description:
//		Create the device server process with all its devices in the database
// given as input arg
//
// argument:
// 		in :
...
//
// description:
//		Store all properties (for classes and devices) in the database specified
// by the input arg
//
// argument:
// 		in :
...
//
// description:
//		Constructor for the DbServerData inner structure TangoDevice. There is one
// instance of this struc for 		every device defined in the device server
// process
//
// argument:
// 		in :
...
//
// description:
//		Constructor for the DbServerData inner structure TangoClass. There is one
// instance of this struc for 		every tango class defined in the device server
// process
//
// argument:
// 		in :
