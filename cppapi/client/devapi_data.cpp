...
bool DeviceData::operator>>(bool &datum)
{
  ...
  if(ret == false)
  {
    ...
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(unsigned short &) - extract a unsigned short from
// DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(DevLong &datum)
{
  ...
  if(ret == false)
  {
    ...
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not a DevLong (long 32 bits)");
    }
  }
  return ret;
}
...
bool DeviceData::operator>>(DevULong &datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not an DevULong (unsigned long 32 bits)");
    }
  }
  return ret;
}
...
bool DeviceData::operator>>(DevULong64 &datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not a DevULong64 (unsigned 64 bits long)");
    }
  }
  return ret;
}
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(const char* &) - extract a const char* from
// DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<bool> &) - extract a vector<bool> from
// DeviceData
//
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarBooleanArray *) - extract a DevVarBooleanArray
// from DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<unsigned char> &) - extract a
// vector<unsigned char> from DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarCharArray *) - extract a DevVarCharArray from
// DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<short> &) - extract a vector<short> from
// DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarShortArray *) - extract a DevVarShortArray from
// DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<unsigned short> &) - extract a
// vector<unsigned short> from DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(std::vector<unsigned short> &datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not an array of unsigned short");
    }
  }
  else
  {
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarUShortArray *) - extract a DevVarUShortArray
// from DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(const DevVarUShortArray *&datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not an array of unusigned short");
    }
  }
  return ret;
}
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<DevLong> &) - extract a vector<DevLong>
// from DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(std::vector<DevLong> &datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not an array of DevLong (long 32 bits)");
    }
  }
  else
  {
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarLongArray *) - extract a DevVarLongArray from
// DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<DevULong> &) - extract a vector<DevULong>
// from DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(std::vector<DevULong> &datum)
{
  ...
  if(ret == false)
  {
    ...
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is not an array of "
                                "DevULong (unsigned long 32 bits)");
    }
  }
  else
  {
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarULongArray *) - extract a DevVarULongArray from
// DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(const DevVarULongArray *&datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not an array of unsigned long (32 bits)");
    }
  }
  return ret;
}
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarLong64Array *) - extract a DevVarLong64Array
// from DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarULong64Array *) - extract a DevVarULong64Array
// from DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(const DevVarULong64Array *&datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not an array of unsigned long (64 bits)");
    }
  }
  return ret;
}
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<DevLong64> &) - extract a
// vector<DevLong64> from DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(std::vector<DevLong64> &datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not an array of DevLong64 (64 bits long)");
    }
  }
  else
  {
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<DevULong64> &) - extract a
// vector<DevULong64> from DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(std::vector<DevULong64> &datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is not an array of "
                                "DevULong64 (unsigned 64 bits long)");
    }
  }
  else
  {
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<float> &) - extract a vector<float> from
// DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarFloatArray *) - extract a DevVarFloatArray from
// DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<double> &) - extract a vector<double>
// from DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarDoubleArray *) - extract a DevVarDoubleArray
// from DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(std::vector<std::string> &) - extract a
// vector<string> from DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarStringArray *) - extract a DevVarStringArray
// from DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<bool> &) - insert a vector<bool>
// into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<unsigned char> &) - insert a
// vector<unsigned char> into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<short> &) - insert a vector<short>
// into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<unsigned short> &) - insert a
// vector<unsigned short> into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<DevLong> &) - insert a
// vector<DevLong> into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<DevULong> &) - insert a
// vector<DevULong> into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<float> &) - insert a vector<float>
// into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<double> &) - insert a
// vector<double> into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<std::string> &) - insert a
// vector<string> into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<DevLong64> &) - insert a
// vector<DevLong64> into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator <<(const std::vector<DevULong64> &) - insert a
// vector<DevULong64> into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::insert (std::vector<DevLong>, std::vector<std::string> &) -
// insert a pair of
...
//-----------------------------------------------------------------------------
//
// DeviceData::extract (std::vector<DevLong>, std::vector<std::string> &) -
// extract a pair of
...
bool DeviceData::extract(std::vector<DevLong> &long_datum, std::vector<std::string> &string_datum)
{
  ...
  if(ret == false)
  {
    ...
    if(exceptions_flags.test(wrongtype_flag))
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is "
                                "not a structure with sequences of "
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarLongStringArray *) - insert a
// DevVarLongStringArray into DeviceData
//
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// DeviceData::insert (std::vector<double>, std::vector<std::string> &) - insert
// a pair of
...
//-----------------------------------------------------------------------------
//
// DeviceData::extract (std::vector<double>, std::vector<std::string> &) -
// extract a pair of
...
//-----------------------------------------------------------------------------
//
// DeviceData::operator >>(DevVarDoubleStringArray *) - insert a
// DevVarDoubleStringArray into DeviceData
//
//-----------------------------------------------------------------------------
...
bool DeviceData::operator>>(const DevVarDoubleStringArray *&datum)
{
  ...
  if(ret == false)
  {
    ...
    {
      TANGO_THROW_API_EXCEPTION(ApiDataExcept, API_IncompatibleCmdArgumentType,
                                "Cannot extract, data in DeviceData object is not a structure with "
                                "sequences of string(s) and double(s) ");
    }
  }
  return ret;
}
...
//-----------------------------------------------------------------------------
//
// DeviceData::insert (std::string, std::vector<unsigned char> &) - insert a
// pair of
