 ...
 * properties, import and export information for a device. This class provides
 * an easy to use interface for device objects in the database. It uses the
 * methods of the Database class therefore the reader is referred to these for
 * the exact calling syntax and examples. The following methods are defined for
 * the DbDevice class :
 *
 * $Author: taurel $
 * $Revision: 1 $
...
public:
   ...
   *
   * A constructor for a DbDevice object for a device in the TANGO database
   ...
   *
   * A constructor for a DbDevice object for the device in the specified
   ...
   * Database::get_device_property() for an example of how to specify and
   ...
   * Database::put_device_property() for an example of how to specify the
   * properties.
   *
   ...
   * See Database::delete_property() for an example of how to specify the
   * properties.
   *
   ...
   * Database::get_device_attribute_property() for an example of how to specify
   ...
   * in the database. See Database::delete_device_attribute_property() for an
   ...
   * Database::get_device_pipe_property() for an example of how to specify and
   * retrieve the properties.
   *
   * @param [in,out] db Property name(s) and value
   *
   ...
   * Database::put_device_pipe_property() for an example of how to specify the
   * properties.
   *
   * @param [in] db Property name(s) and value
   *
   ...
   * the database. See Database::delete_device_pipe_property() for an example of
