...
void DeviceProxy::from_hist4_2_DataHistory(const DevCmdHistory_4_var &hist_4, std::vector<DeviceDataHistory> *ddh)
{
  ...
  for(loop = 0; loop < h_depth; loop++)
  {
    ...
    case Tango::DEVVAR_SHORTARRAY:
    {
      ...
      Tango::DevVarShortArray ShortSeq =
          DevVarShortArray(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEVVAR_LONGARRAY:
    {
      ...
      Tango::DevVarLongArray LongSeq =
          DevVarLongArray(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEVVAR_FLOATARRAY:
    {
      ...
      Tango::DevVarFloatArray FloatSeq =
          DevVarFloatArray(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEVVAR_DOUBLEARRAY:
    {
      ...
      Tango::DevVarDoubleArray DoubleSeq =
          DevVarDoubleArray(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEVVAR_LONG64ARRAY:
    {
      ...
      Tango::DevVarLong64Array Long64Seq =
          DevVarLong64Array(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEVVAR_USHORTARRAY:
    {
      ...
      Tango::DevVarUShortArray UshSeq =
          DevVarUShortArray(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEVVAR_ULONGARRAY:
    {
      ...
      Tango::DevVarULongArray UlgSeq =
          DevVarULongArray(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEVVAR_ULONG64ARRAY:
    {
      ...
      Tango::DevVarULong64Array Ulg64Seq =
          DevVarULong64Array(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEVVAR_CHARARRAY:
    {
      ...
      Tango::DevVarCharArray CharSeq =
          DevVarCharArray(data_length, data_length, &(seq_buff[base - data_length]), false);
    ...
    case Tango::DEV_ENCODED:
    {
      /*				Tango::DevEncoded &tmp_data = (*tmp_enc)[base - 1];
                                      ...
                                      EncSeq.encoded_format =
         Tango::string_dup(tmp_data.encoded_format); unsigned int buffer_length
         = tmp_data.encoded_data.length();
                                      EncSeq.encoded_data.length(buffer_length);
                                      for (unsigned int ll = 0;ll <<
         buffer_length;++ll) EncSeq.encoded_data[ll] =
         tmp_data.encoded_data[ll];*/
...
{
  return name == dac.name && writable == dac.writable && data_format == dac.data_format && data_type == dac.data_type &&
         max_dim_x == dac.max_dim_x && max_dim_y == dac.max_dim_y && description == dac.description &&
         label == dac.label && unit == dac.unit && standard_unit == dac.standard_unit &&
         display_unit == dac.display_unit && format == dac.format && min_value == dac.min_value &&
         max_value == dac.max_value && min_alarm == dac.min_alarm && max_alarm == dac.max_alarm &&
         writable_attr_name == dac.writable_attr_name && extensions == dac.extensions;
}
