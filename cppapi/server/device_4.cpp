...
Device_4Impl::Device_4Impl(DeviceClass *device_class, const std::string &dev_name)
...
Device_4Impl::Device_4Impl(DeviceClass *device_class, const std::string &dev_name, const std::string &desc)
...
Device_4Impl::Device_4Impl(DeviceClass *device_class, const char *dev_name, const char *desc, Tango::DevState dev_state,
...
Tango::DevAttrHistory_4 *Device_4Impl::read_attribute_history_4(const char *name, CORBA::Long n)
{
  ...
  cout4 << "Device_4Impl::read_attribute_history_4 arrived, requested history "
           "depth = "
        << n << std::endl;
...
CORBA::Any *Device_4Impl::command_inout_4(const char *in_cmd, const CORBA::Any &in_data, Tango::DevSource source,
