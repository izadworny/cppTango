...
// file :		attrdesc.h
//
// description :	Include file for the Attr classes hierarchy. Three classes are
...
public:
   ...
   */
  void set_label(const char *def_label) { label = def_label; }
   ...
   */
  void set_description(const char *def_desc) { description = def_desc; }
   ...
   */
  void set_unit(const char *def_unit) { unit = def_unit; }
   ...
   */
  void set_standard_unit(const char *def_std_unit) { standard_unit = def_std_unit; }
   ...
   */
  void set_display_unit(const char *def_disp_unit) { display_unit = def_disp_unit; }
   ...
   */
  void set_format(const char *def_format) { format = def_format; }
   ...
   */
  void set_min_value(const char *def_min_value) { min_value = def_min_value; }
   ...
   */
  void set_max_value(const char *def_max_value) { max_value = def_max_value; }
   ...
   */
  void set_min_alarm(const char *def_min_alarm) { min_alarm = def_min_alarm; }
   ...
   */
  void set_max_alarm(const char *def_max_alarm) { max_alarm = def_max_alarm; }
   ...
   */
  void set_min_warning(const char *def_min_warning) { min_warning = def_min_warning; }
   ...
   */
  void set_max_warning(const char *def_max_warning) { max_warning = def_max_warning; }
   ...
   */
  void set_delta_t(const char *def_delta_t) { delta_t = def_delta_t; }
   ...
   */
  void set_delta_val(const char *def_delta_val) { delta_val = def_delta_val; }
   ...
   */
  void set_event_abs_change(const char *def_abs_change) { abs_change = def_abs_change; }
   ...
   */
  void set_event_rel_change(const char *def_rel_change) { rel_change = def_rel_change; }
   ...
   */
  void set_event_period(const char *def_period) { period = def_period; }

  /**
   * Set default archive event abs_change property
   *
   * @param	def_archive_abs_change	The user default archive event abs_change
   * property
   */
  void set_archive_event_abs_change(const char *def_archive_abs_change) { archive_abs_change = def_archive_abs_change; }

  /**
   * Set default archive event rel_change property
   *
   * @param	def_archive_rel_change	The user default archive event rel_change
   * property
   */
  void set_archive_event_rel_change(const char *def_archive_rel_change) { archive_rel_change = def_archive_rel_change; }
   ...
   */
  void set_archive_event_period(const char *def_archive_period) { archive_period = def_archive_period; }
  ...
  void set_abs_change(const char *def_abs_change) { set_event_abs_change(def_abs_change); }

  void set_rel_change(const char *def_rel_change) { set_event_rel_change(def_rel_change); }

  void set_period(const char *def_period) { set_event_period(def_period); }
  ...
  void set_archive_period(const char *def_archive_period) { set_archive_event_period(def_archive_period); }
...
public:
   ...
   *
   */
  Attr(const char *name, long data_type, Tango::AttrWriteType w_type = Tango::READ,
   ...
   *
   */
  Attr(const char *name, long data_type, Tango::DispLevel disp, Tango::AttrWriteType w_type = Tango::READ,
       const char *assoc = AssocWritNotSpec);
   ...
   * attribute)
   * By default the setpoint will be written to the attribute during
   * initialisation! Use method set_memorized_init() with false as argument if
   ...
   * 	true  = the setpoint value will be written to the attribute on
   * initialisation false = only the attribute setpoint is initialised. No
   * action is taken on the attribute
   *
   * @param	write_on_init	If true the setpoint value will be written to the
   * attribute on initialisation
   */
   ...
   * fulfilled. If detect is set to false the event is fired without checking!
   *
   ...
   * false the event is fired without checking!
   *
