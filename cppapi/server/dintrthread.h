...
// file :               dintrthread.h
//
// description :        Include for the DevIntrThread object. This class
// implements the thread used to push device
...
//
// description :
//		This structure is used to shared data between the Device interface change
...
//
// description :
//		Class to store all the necessary information for the device interface
// change event thread. 		It's run() method is the thread code 		This is a
// detached thread
//
//=================================================================================================================
