...
private:
  ...
  void event_subscription(const std::string &, const std::string &, const std::string &, std::string &,
                          const std::string &, ChannelType, std::string &, int &, int &, DeviceImpl *, int l = 0);
