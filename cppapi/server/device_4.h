...
class Device_4Impl : public virtual POA_Tango::Device_4, public Device_3Impl
{
public:
  /**@name Constructors
  ...
  /**
   * Constructs a newly allocated Device_4Impl object from its name and its
   * description.
   *
   * The device
   * state is set to unknown and the device status is set to
   ...
   *
   */
  Device_4Impl(DeviceClass *device_class, const char *dev_name, const char *desc = "A TANGO device",
   ...
   *
   * Invoked when the client request the read_attribute_history_3 CORBA
   ...
   * @return A DevAttrHistory_4 structure. This strucure contains all the
   ...
   *
   * Invoked when the client request the command_inout_history_2 CORBA
   * operation. This operation allows a client to retrieve command return value
   * history for polled command. The depth of the history is limited to the
   * depth of the device server internal polling buffer. It returns to the
   * client one DevCmdHistory structure for each record.
   *
   * @param command The command name
   * @param n The record number.
   * @return A DevCmdHistory_4 structure. This strucure contains all the element
   * allowing a client to retrieve for each history record the command return
   * value (in an Any), the date and in case of the command returns an error
   * when it was read, the DevErrors data. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#structs">here</a>
   ...
   * requested by a client. It checks the device lock, updates the device
   * black-box, call the TANGO command handler and returned the output Any
   *
   ...
   * @exception DevFailed Re-throw of the exception thrown by the
   * command_handler method. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#exceptions">here</a>
   * to read <b>DevFailed</b> exception specification
   */
  virtual CORBA::Any *command_inout_4(const char *in_cmd, const CORBA::Any &in_data, Tango::DevSource source,
   ...
   * @param cl_ident The client identificator. This parameter is new in
   * release 4. It allows device locking feature implemented in Tango V7
   * @return A sequence of AttributeValue_4 structure. One structure is
   ...
   * to read <b>DevFailed</b> exception specification
   */
  virtual Tango::AttributeValueList_4 *read_attributes_4(const Tango::DevVarStringArray &names, Tango::DevSource source,
                                                         const Tango::ClntIdent &cl_ident);
...
private:
  ...
  std::unique_ptr<Device_4ImplExt> ext_4; // Class extension
};
