  ...
  try
  {
    for(i = 0; i < nb_attr; i++)
    {
      ...
      if((event_supplier_nd != NULL) || (event_supplier_zmq != NULL))
      {
        ...
        //
        // The event data has to be the new attribute conf which could be different than the one we received (in case
        // some of the parameters are reset to lib/user/class default value)
        //
