...
// the black box objects which keep tracks
...
public:
  ...
  {
    client_ip[0] = '\0';
    ::memset(java_ident, 0, sizeof(DevULong64) << 1);
  }
...
//
// description :
//		Class to store all the necessary information which will be stored and
// returned to client on request
//
//==================================================================================================================
...
inline bool operator<(const BlackBoxElt &, const BlackBoxElt &) { return true; }
...
//
// description :
//		Class to implement the black box itself. This is mainly a vector of
// BlackBoxElt managed as a circular
// vector
//
//===================================================================================================================
...
public:
  ...
  void insert_wr_attr(const Tango::AttributeValueList_4 &, const Tango::DevVarStringArray &, const ClntIdent &,
                      long vers);
