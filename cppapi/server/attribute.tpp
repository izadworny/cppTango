...
{
  if(!(data_type == DEV_ENCODED && ranges_type2const<T>::enu == DEV_UCHAR) && (data_type != ranges_type2const<T>::enu))
  {
    std::string err_msg =
        "Attribute (" + name + ") data type does not match the type provided : " + ranges_type2const<T>::str;
    TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, err_msg.c_str());
  ...
  {
    TANGO_THROW_EXCEPTION(API_AttrNotAllowed, "Minimum alarm not defined for this attribute");
  }
...
void Attribute::get_max_alarm(T &max_al)
{
  ...
  {
    TANGO_THROW_EXCEPTION(API_AttrNotAllowed, "Maximum alarm not defined for this attribute");
  }
...
void Attribute::get_min_warning(T &min_war)
{
  ...
  {
    std::string err_msg =
        "Minimum warning has no meaning for the attribute's (" + name + ") data type : " + ranges_type2const<T>::str;
    TANGO_THROW_EXCEPTION(API_AttrOptProp, err_msg.c_str());
  }

  if(!alarm_conf[min_warn])
  {
    TANGO_THROW_EXCEPTION(API_AttrNotAllowed, "Minimum warning not defined for this attribute");
  }
...
void Attribute::get_max_warning(T &max_war)
{
  ...
  {
    std::string err_msg =
        "Maximum warning has no meaning for the attribute's (" + name + ") data type : " + ranges_type2const<T>::str;
    TANGO_THROW_EXCEPTION(API_AttrOptProp, err_msg.c_str());
  }

  if(!alarm_conf[max_warn])
  {
    TANGO_THROW_EXCEPTION(API_AttrNotAllowed, "Maximum warning not defined for this attribute");
  }
...
void Attribute::get_properties(Tango::MultiAttrProp<T> &props)
{
  ...
  if(!(data_type == DEV_ENCODED && ranges_type2const<T>::enu == DEV_UCHAR) &&
     !(data_type == DEV_ENUM && ranges_type2const<T>::enu == DEV_SHORT) && (data_type != ranges_type2const<T>::enu))
  {
    std::string err_msg =
        "Attribute (" + name + ") data type does not match the type provided : " + ranges_type2const<T>::str;
    TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, err_msg.c_str());
...
void Attribute::AttrValUnion_fake_copy(const T *src, V *dst)
{
  ...
  case ATT_LONG64:
  {
    ...
    DevVarLong64Array tmp_seq_4(tmp_seq.length(), tmp_seq.length(), const_cast<DevLong64 *>(tmp_seq.get_buffer()),
                                false);
  ...
  case ATT_UCHAR:
  {
    ...
    DevVarCharArray tmp_seq_4(tmp_seq.length(), tmp_seq.length(), const_cast<unsigned char *>(tmp_seq.get_buffer()),
                              false);
  ...
  case ATT_USHORT:
  {
    ...
    DevVarUShortArray tmp_seq_4(tmp_seq.length(), tmp_seq.length(), const_cast<DevUShort *>(tmp_seq.get_buffer()),
                                false);
  ...
  case ATT_ULONG64:
  {
    ...
    DevVarULong64Array tmp_seq_4(tmp_seq.length(), tmp_seq.length(), const_cast<DevULong64 *>(tmp_seq.get_buffer()),
                                 false);
  ...
  case ATT_STRING:
  {
    ...
    DevVarStringArray tmp_seq_4(tmp_seq.length(), tmp_seq.length(), const_cast<DevString *>(tmp_seq.get_buffer()),
                                false);
  ...
  case ATT_ENCODED:
  {
    ...
    DevVarEncodedArray tmp_seq_4(tmp_seq.length(), tmp_seq.length(), const_cast<DevEncoded *>(tmp_seq.get_buffer()),
                                 false);
