...
class Device_3Impl : public virtual POA_Tango::Device_3, public Device_2Impl
{
public:
  /**@name Constructors
  ...
  /**
   * Constructs a newly allocated Device_3Impl object from its name and its
   * description.
   *
   * The device
   * state is set to unknown and the device status is set to
   ...
   *
   */
  Device_3Impl(DeviceClass *device_class, const char *dev_name, const char *desc = "A TANGO device",
   ...
   *
   * @param names The attribute(s) name list
   * @return A sequence of AttributeConfig_3 structure. One structure is
...
protected:
  /// @privatesection
  void read_attributes_no_except(const Tango::DevVarStringArray &, Tango::AttributeIdlData &, bool,
                                 std::vector<long> &);
