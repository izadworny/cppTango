...
public:
   ...
   *
   * This method returns a reference to the Attribute object from the index in
   * the main attribute vector
   *
   ...
   * @exception DevFailed If the attribute does not have any alarm level
   * defined. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#exceptions">here</a>
   * to read <b>DevFailed</b> exception specification
   *
