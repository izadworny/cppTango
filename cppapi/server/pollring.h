...
// the polling ring buffer.
//						Command result or attribute values are stored in this buffer
// manages as a ring 						buffer.
//
// project :            TANGO
//
// author(s) :          E.Taurel
...
inline bool operator<(const RingElt &, const RingElt &) { return true; }
...
//
// description :
//		Class to implement the ring buffer itself. This is mainly a vector of
// RingElt managed as a circular
// buffer
//
//==================================================================================================================
...
public:
  ...
  template <typename T>
  void get_attr_history(long, T *, long);
