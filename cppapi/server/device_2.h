...
class Device_2Impl : public virtual POA_Tango::Device_2, public DeviceImpl
{
public:
  /**@name Constructors
   ...
   *
   */
  Device_2Impl(DeviceClass *device_class, const std::string &dev_name);

  /**
   * Constructs a newly allocated Device_2Impl object from its name and its
   * description.
   *
   * The device
   * state is set to unknown and the device status is set to
   ...
   *
   */
  Device_2Impl(DeviceClass *device_class, const std::string &dev_name, const std::string &desc);
   ...
   *
   */
  Device_2Impl(DeviceClass *device_class, const char *dev_name, const char *desc = "A TANGO device",
   ...
   * @return A sequence of AttributeValue structure. One structure is
   ...
   *
   * @param names The attribute(s) name list
   * @return A sequence of AttributeConfig_2 structure. One structure is
   ...
   *
   * Invoked when the client request the read_attribute_history_2 CORBA
   ...
   * @return A sequence of DevAttrHistory structure. One structure is
   * initialised for each record with the attribute value, the date and in case
   * of the attribute returns an error when it was read, the DevErrors data.
   * Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#structs">here</a>
