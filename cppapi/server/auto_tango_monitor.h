...
//
// description :
//		This class is only a helper class used to get a TangoMonitor object during
// its construction and to 		it during its destruction. It makes developer life
// easier.
//
//-------------------------------------------------------------------------------------------------------------------
...
// description :
//		This class is only a helper class used to get a TangoMonitor object during
// its construction and to 		it during its destruction only if the device
// server process is in NO_SYNC synchronisation model
//
//--------------------------------------------------------------------------------------------------------------------
