...
// file :               Command.cpp
//
// description :        C++ source code for the Command and templCommand
// classes.
...
Command::Command(const std::string &s, Tango::CmdArgType in, Tango::CmdArgType out, const std::string &in_desc,
...
TemplCommand::TemplCommand(const std::string &s, void (DeviceImpl::*f)(), const std::string &in_desc,
                           const std::string &out_desc, Tango::DispLevel level)
    : Command(s, Tango::DEV_VOID, Tango::DEV_VOID, in_desc, out_desc, level),
      exe_ptr(f),
      ext(nullptr)
...
void TemplCommand::set_type(const std::type_info &data_type, Tango::CmdArgType &type)
{
  ...
  else if((data_type == typeid(Tango::DevVarLong64Array)) || (data_type == typeid(const Tango::DevVarLong64Array *)) ||
  ...
  else if((data_type == typeid(Tango::DevVarDoubleArray)) || (data_type == typeid(const Tango::DevVarDoubleArray *)) ||
          (data_type == typeid(Tango::DevVarDoubleArray *)))
  {
    cout4 << "Command : " << name << ", Type is a double array" << std::endl;
    type = Tango::DEVVAR_DOUBLEARRAY;
  }
  else if((data_type == typeid(Tango::DevVarUShortArray)) || (data_type == typeid(const Tango::DevVarUShortArray *)) ||
  ...
  else if((data_type == typeid(Tango::DevVarStringArray)) || (data_type == typeid(const Tango::DevVarStringArray *)) ||
