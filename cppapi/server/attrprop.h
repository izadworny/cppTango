...
// file :		AttrProp.h
//
// description :	Include file for the AttrProp, DoubleAttrProp and
...
//
// description :
//		This is a template class which holds a value of attribute property and its
...
public:
   ...
   */
  AttrProp(const std::string &value_str)
      : str(value_str),
        is_value(false),
        ext(nullptr)
  {
   ...
   *
   * @param value_str A 'C string' representation of the attribute property
   * value.
   *
   ...
   *
   * @param value_str The the 'C string' representation of the attribute
   * property value.
   */
   ...
   * Set string representation of the attribute property value.
   *
   * @param value_str The the string representation of the attribute property
   * value.
   */
  void set_str(const std::string &value_str)
  {
    str      = value_str;
    is_value = false;
  }
   ...
   *
   * This method returns a boolean set to true if the attribute property value
   * has been assigned.
   *
   * @return A boolean set to true if the attribute property value has been
   * assigned
   */
...
// attribute property (like rel_change,
//					abs_change, archive_rel_change, archive_abs_change) which consists
// of two values, and its string 					representation.
//
//==================================================================================================================
...
public:
   ...
   */
  DoubleAttrProp(const std::vector<T> &values)
      : val(values),
        is_value(true)
  {
    TangoSys_MemStream st;
   ...
   * Create a new DoubleAttrProp object.
   *
   * @param value The figure assigned to both values of the compound attribute
   * property.
   */
   ...
   * Create a new DoubleAttrProp object.
   *
   * @param value_str The 'C string' representation of values of the compound
   * attribute property.
   */
   ...
   * Create a new DoubleAttrProp object.
   *
   * @param value_str The string representation of values of the compound
   * attribute property.
   */
  DoubleAttrProp(const std::string &value_str)
      : str(value_str),
        is_value(false)
  {
  }
   ...
   *
   * @return DoubleAttrProp object with both values of the compound attribute
   * property and their string representation set.
   */
   ...
   * Assign the values of the compound attribute property.
   *
   * @param value A figure representing both values of the compound attribute
   * property.
   *
   * @return DoubleAttrProp object with both values of the compound attribute
   * property and their string representation set.
   ...
   * Assign the values of the compound attribute property.
   *
   * @param value_str A 'C string' representation of values of the compound
   * attribute property.
   *
   ...
   * Assign the values of the compound attribute property.
   *
   * @param value_str A string representation of values of the compound
   * attribute property.
   *
   * @return DoubleAttrProp object with string representation of values of
   * the compound attribute property set.
   ...
   *
   * @return The string representation of the compound attribute property
   * values.
   */
  std::string &get_str() { return str; }
   ...
   *
   * @param value The figure representing both values of the compound attribute
   * property.
   */
  void set_val(const T &value)
  {
   ...
   *
   * @param value_str The 'C string' representation of the compound attribute
   * property values.
   */
  void set_str(const char *value_str)
  {
   ...
   * Set string representation of the compound attribute property values.
   *
   * @param value_str The string representation of the compound attribute
   * property values.
   */
  void set_str(const std::string &value_str)
  {
   ...
   *
   * @return A boolean set to true if the compound attribute property values
   * have been assigned
   */
  bool is_val() { return is_value; }
...
public:
  ...
  #pragma clang diagnostic ignored "-Wundefined-var-template"
    ...
    CmdArgType type = ranges_type2const<T>::enu; // restricts template initialisation to
                                                 // supported types
