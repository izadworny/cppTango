...
struct LastAttrValue
{
  ...
  void store(const AttributeValue_5 *, const AttributeValue_4 *, const AttributeValue_3 *, const AttributeValue *,
             DevFailed *);
};
...
// remove once https://gitlab.com/tango-controls/cppTango/-/issues/786 is fixed
   ...
   *
   * @return A boolean set to true if the attribute is in warning condition
   * (read value below the min. warning).
   */
   ...
   *
   * @return A boolean set to true if the attribute is in warning condition
   * (read value above the max. warning).
   */
   ...
   *
   * @param val The new index in the main attribute vector of the associated
   * writable attribute
   */
  ...
  {
    when.tv_sec  = (long) t.time;
    when.tv_usec = (t.millitm * 1000);
    when.tv_nsec = 0;
  }
#endif
  /**
  ...
  {
    when.tv_sec  = t.tv_sec;
    when.tv_usec = t.tv_usec;
    when.tv_nsec = 0;
  }
   ...
   *
   * @return The attribute data size in x dimension. Set to 1 for scalar
   * attribute
   */
   ...
   *
   * @return The attribute maximum data size in x dimension. Set to 1 for scalar
   * attribute
   */
   ...
   *
   * @return The attribute maximum data size in y dimension. Set to 0 for scalar
   ...
   *
   * This method initializes the members of a MultiAttrProp object with the
   * modifiable attribute properties values
   *
   ...
   * model.
   *
   * @param ser_model The new serialisation model. The serialization model must
   * be one of ATTR_BY_KERNEL, ATTR_BY_USER or ATTR_NO_SYNC
   */
   ...
   * the omni_mutex used to protect its buffer. The mutex has to be locked when
   * passed to this method. The Tango kernel will unlock it when the data will
   ...
   * will be returned to the caller. This method also stores the date when it is
   * called and initialise the attribute quality factor.
   *
   ...
   * @param release The release flag. If true, memory pointed to by p_data will
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevShort
   * attribute data type).
   *
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevShort *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);

#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevShort *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevShort *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevLong
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevLong *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevLong *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevLong
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevLong *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevLong64
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevLong64 *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevLong64 *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevLong64
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevLong64 *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevFloat
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
  ...
  void set_value_date_quality(Tango::DevFloat *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevFloat *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevFloat
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevFloat *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevDouble
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
  ...
  void set_value_date_quality(Tango::DevDouble *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevDouble *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevDouble
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevDouble *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevString
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevString *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevString *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevString
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevString *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  void set_value_date_quality(Tango::DevBoolean *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevBoolean *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevBoolean *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevUShort
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
  ...
  void set_value_date_quality(Tango::DevUShort *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevUShort *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevUShort
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevUShort *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevUChar
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
  ...
  void set_value_date_quality(Tango::DevUChar *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevUChar *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevUChar
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevUChar *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevULong
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevULong *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevULong *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevULong
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevULong *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevULong64 *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevULong64 *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevULong64 *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
  ...
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevState
   * attribute data type).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevState *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevState *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for Tango::DevState
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevState *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
#endif
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevEncoded *p_data, time_t t, Tango::AttrQuality qual, long x = 1, long y = 0,
                              bool release = false);
  /**
   * Set internal attribute value, date and quality factor (for
  ...
  void set_value_date_quality(Tango::DevString *p_data_str, Tango::DevUChar *p_data, long size, time_t t,
                              Tango::AttrQuality qual, bool release = false);
#ifdef _TG_WINDOWS_
  void set_value_date_quality(Tango::DevEncoded *p_data, struct _timeb &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);

  void set_value_date_quality(Tango::DevString *p_data_str, Tango::DevUChar *p_data, long size, struct _timeb &t,
                              Tango::AttrQuality qual, bool release = false);
#else
  /**
   * Set internal attribute value, date and quality factor (for
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevEncoded *p_data, struct timeval &t, Tango::AttrQuality qual, long x = 1,
                              long y = 0, bool release = false);
  /**
   * Set internal attribute value, date and quality factor (for
   * Tango::DevEncoded attribute data type when splitted in data format and data
   * themselves).
   *
   * This method stores the attribute read value, the date and the attribute
   * quality factor inside the object. This data will be
   ...
   * to read <b>DevFailed</b> exception specification
   */
  void set_value_date_quality(Tango::DevString *p_data_str, Tango::DevUChar *p_data, long size, struct timeval &t,
                              Tango::AttrQuality qual, bool release = false);
#endif

  /**
   * Fire a change event for the attribute value. The event is pushed to the
   *notification daemon. The attribute data must be set with one of the
   *Attribute::set_value or Attribute::setvalue_date_quality methods before
   *fireing the event. The event is triggered with or without the change event
   *criteria depending on the configuration choosen with set_change_event().
   * ATTENTION: The couple set_value() and fire_change_event() needs to be
   ...
   *thread. Inside all methods reading or writing commands and attributes this
   *protection is automatically done by the Tango serialisation monitor. When
   *fireing change events in your own code, you should use the push_change_event
   ...
   *	}
   *
   * @param except A pointer to a DevFailed exception to be thrown as archive
   *event.
   */
   ...
   * parameter is set to true, the criteria specified for the change event are
   * verified and the event is only pushed if they are fulfilled. If detect is
   * set to false the event is fired without any value checking!
   *
   * @param implemented True when the server fires change events manually.
   * @param detect Triggers the verification of the change event properties when
   * set to true.
   */
  ...
  /**
   * Fire an archive event for the attribute value. The event is pushed to the
   *notification daemon. The attribute data must be set with one of the
   *Attribute::set_value or Attribute::setvalue_date_quality methods before
   *fireing the event. The event is triggered with or without the archive event
   *criteria depending on the configuration choosen with set_archive_event().
   * ATTENTION: The couple set_value() and fire_archive_event() needs to be
   *protected against concurrent accesses to the same attribute. Such an access
   *might happen during a synchronous read or by a reading from the polling
   *thread. Inside all methods reading or writing commands and attributes this
   *protection is automatically done by the Tango serialisation monitor. When
   *fireing archive events in your own code, you should use the
   *push_archive_event methods of the DeviceImpl class or protect your code with
   *the Tango::AutoTangoMonitor on your device. Example:
   *
   *	{
   * 		Tango::AutoTangoMonitor synch(this);
   *		att_temp_seq.set_value (temp_seq, 100);
   ...
   * and the event is only pushed if they are fulfilled. If detect is set to
   * false the event is fired without any value checking!
   *
   ...
   *
   * @return A boolean set to true if a manual fire archive event is
   * implemented.
   */
  ...
  /**
   * Fire a user event for the attribute value. The event is pushed to the
   *notification daemon. The attribute data must be set with one of the
   *Attribute::set_value or Attribute::setvalue_date_quality methods before
   *fireing the event. ATTENTION: The couple set_value() and fire_event() needs
   *to be protected against concurrent accesses to the same attribute. Such an
   *access might happen during a synchronous read or by a reading from the
   *polling thread. Inside all methods reading or writing commands and
   *attributes this protection is automatically done by the Tango serialisation
   *monitor. When fireing archive events in your own code, you should use the
   *push_event methods of the DeviceImpl class or protect your code with the
   * Tango::AutoTangoMonitor on your device.
   * Example:
   *
   *	{
   ...
   *event.
   */
  void fire_event(const std::vector<std::string> &filt_names, const std::vector<double> &filt_vals,
                  DevFailed *except = NULL);

  /**
   * Remove the attribute configuration from the database.
   * This method can be used to clean-up all the configuration of an attribute
   * to come back to its default values or the remove all configuration of a
   * dynamic attribute before deleting it.
   *
  ...
  /**@name Set/Get attribute ranges (min_alarm, min_warning, max_warning,
   * max_alarm) methods. These methods allow the external world to set attribute
   * object min_alarm, min_warning, max_warning and max_alarm values
   */
  //@{
   ...
   *
   * @param min_al Reference to a variable which value will be set to the
   * attribute's minimum alarm
   */
  template <typename T>
   ...
   *
   * @param max_al Reference to a variable which value will be set to the
   * attribute's maximum alarm
   */
  template <typename T>
   ...
   *
   * @param min_war Reference to a variable which value will be set to the
   * attribute's minimum warning
   */
  template <typename T>
   ...
   *
   * @param max_war Reference to a variable which value will be set to the
   * attribute's maximum warning
   */
  template <typename T>
...
protected:
   ...
   * Tango::DevBoolean, Tango::DevState, Tango::DevEncoded and Tango::DevEnum
   */
  long data_type;
  /**
  ...
  /**
   * Index in the main attribute vector of the associated writable attribute (if
   * any)
   */
  long assoc_ind;
  /**
...
private:
  ...
  bool init_check_val_prop(std::vector<AttrProperty> &, const std::string &, const char *, std::string &,
                           Tango::Attr_CheckVal &, const Tango::Attr_CheckVal &);
...
protected:
  ...
  void set_one_str_prop(const char *, const CORBA::String_member &, std::string &, std::vector<AttPropDb> &,
                        const std::vector<AttrProperty> &, const std::vector<AttrProperty> &, const char *);
  void set_one_alarm_prop(const char *, const CORBA::String_member &, std::string &, Tango::Attr_CheckVal &,
                          std::vector<AttPropDb> &, const std::vector<AttrProperty> &,
                          const std::vector<AttrProperty> &, bool &);
  void set_rds_prop(const AttributeAlarm &, const std::string &, std::vector<AttPropDb> &,
                    const std::vector<AttrProperty> &, const std::vector<AttrProperty> &);
  void set_rds_prop_val(const AttributeAlarm &, const std::string &, const std::vector<AttrProperty> &,
                        const std::vector<AttrProperty> &);
  void set_rds_prop_db(const AttributeAlarm &, std::vector<AttPropDb> &, const std::vector<AttrProperty> &,
                       const std::vector<AttrProperty> &);
  void set_one_event_prop(const char *, const CORBA::String_member &, double *, std::vector<AttPropDb> &,
                          const std::vector<AttrProperty> &, const std::vector<AttrProperty> &);
  void event_prop_db_xxx(const std::vector<double> &, const std::vector<double> &, std::vector<AttPropDb> &,
                         AttPropDb &);
  void set_one_event_period(const char *, const CORBA::String_member &, int &, const int &, std::vector<AttPropDb> &,
                            const std::vector<AttrProperty> &, const std::vector<AttrProperty> &);
  ...
  PollClock::time_point archive_last_event;    // Last time an archive event was
  ...
  bool change_event_implmented;      // Flag true if a manual fire change event is
                                     // implemented.
  bool archive_event_implmented;     // Flag true if a manual fire archive event is
                                     // implemented.
  bool check_change_event_criteria;  // True if change event criteria should be
                                     // checked when sending the event
  bool check_archive_event_criteria; // True if change event criteria should be
                                     // checked when sending the event
  ...
  bool scalar_str_attr_release;                        // Need memory freeing (scalar string attr, R/W
                                                       // att)
  ...
  std::map<std::string, DevFailed> startup_exceptions; // Map containing exceptions related to attribute
                                                       // configuration raised during the server startup
                                                       // sequence
  bool check_startup_exceptions;                       // Flag set to true if there is at least one
                                                       // exception in startup_exceptions map
  bool startup_exceptions_clear;                       // Flag set to true when the cause for the
                                                       // device startup exceptions has been fixed
  bool att_mem_exception;                              // Flag set to true if the attribute is writable and
                                                       // memorized and if it failed at init
  std::vector<int> client_lib[numEventType];           // Clients lib used (for event
                                                       // sending and compat)
};
  ...
  if(check_startup_exceptions)
  {
    ...
    if(event_exceptions.size() == startup_exceptions.size())
    {
      if(event_exceptions.size() == 1)
        err_msg += "\nSetting a valid value (also 'NaN', 'Not specified' and "
                   "'' - empty string) for any property for "
                   "this attribute will automatically bring the "
                   "above-mentioned property to its library defaults";
      else
        err_msg += "\nSetting a valid value (also 'NaN', 'Not specified' and "
                   "'' - empty string) for any property for "
                   "this attribute will automatically bring the above-listed "
                   "properties to their library defaults";
      err_msg += "\nHint : Check also class level attribute properties";
    }
    else if(event_exceptions.empty() == false)
    {
      if(opt_exceptions.size() == 1)
        err_msg += "\nSetting valid value (also 'NaN', 'Not specified' and '' "
                   "- empty string) for " +
                   opt_exceptions[0] + " ";
      else
      {
        err_msg += "\nSetting valid values (also 'NaN', 'Not specified' and '' "
                   "- empty string) for ";
...
inline bool Attribute::prop_in_list(const char *prop_name, std::string &prop_str, size_t list_size,
