...
RANGES_TYPE2CONST(Tango::DevVarShortArray,DEVVAR_SHORTARRAY)
RANGES_TYPE2CONST(Tango::DevVarUShortArray,DEVVAR_USHORTARRAY)
RANGES_TYPE2CONST(Tango::DevVarLongArray,DEVVAR_LONGARRAY)
RANGES_TYPE2CONST(Tango::DevVarULongArray,DEVVAR_ULONGARRAY)
RANGES_TYPE2CONST(Tango::DevVarLong64Array,DEVVAR_LONG64ARRAY)
RANGES_TYPE2CONST(Tango::DevVarULong64Array,DEVVAR_ULONG64ARRAY)
RANGES_TYPE2CONST(Tango::DevVarCharArray,DEVVAR_CHARARRAY)
RANGES_TYPE2CONST(Tango::DevVarFloatArray,DEVVAR_FLOATARRAY)
RANGES_TYPE2CONST(Tango::DevVarDoubleArray,DEVVAR_DOUBLEARRAY)
RANGES_TYPE2CONST(Tango::DevVarStringArray,DEVVAR_STRINGARRAY)
RANGES_TYPE2CONST(Tango::DevVarBooleanArray,DEVVAR_BOOLEANARRAY)
RANGES_TYPE2CONST(Tango::DevVarLongStringArray,DEVVAR_LONGSTRINGARRAY)
RANGES_TYPE2CONST(Tango::DevVarDoubleStringArray,DEVVAR_DOUBLESTRINGARRAY)
RANGES_TYPE2CONST(Tango::ConstDevString,CONST_DEV_STRING)
