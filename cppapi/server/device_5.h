...
// file :		Device_5.h
//
// description :	Include for the Device root classes in its release 5 (IDL
// release 5, Tango release 9)
//
// project :		TANGO
//
// author(s) :		E.Taurel
...
//
// description :
// 		This class is derived directly from the Tango::Device_skel class generated
// by CORBA. It represents the CORBA
//		servant which will be accessed by the client. It implements all the
// methods and attributes defined in
// the
...
class Device_5Impl : public virtual POA_Tango::Device_5, public Device_4Impl
{
public:
  /**@name Constructors
  ...
  /**
   * Constructs a newly allocated Device_5Impl object from its name and its
   * description.
   *
   * The device
   * state is set to unknown and the device status is set to
   ...
   * state and status parameters. The default device description is <i>A TANGO
   * device</i>. The default device state is <i>UNKNOWN</i> and the default
   * device status is <i>Not initialised</i>.
   *
   * @param 	device_class	Pointer to the device class object
   * @param	dev_name	The device name
   ...
   *
   */
  Device_5Impl(DeviceClass *device_class, const char *dev_name, const char *desc = "A TANGO device",
               Tango::DevState dev_state = Tango::UNKNOWN, const char *dev_status = StatusNotSet);
   ...
   * @param cl_ident The client identificator. This parameter is new in
   * release 4. It allows device locking feature implemented in Tango V7
   * @return A sequence of AttributeValue_5 structure. One structure is
   * initialised for each wanted attribute with the attribute value, the date
   * and the attribute value quality. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#structs">here</a>
   ...
   */
  virtual Tango::AttributeValueList_5 *read_attributes_5(const Tango::DevVarStringArray &names, Tango::DevSource source,
   ...
   * for each wanted attribute with the attribute value. The attribute quality
   * and date are not used by this method. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#structs">here</a>
   * to read <b>AttributeValue</b> structure definition.
   ...
   *
   * @param names The attribute(s) name list
   * @return A sequence of AttributeConfig_5 structure. One structure is
   * initialised for each wanted attribute. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#structs">here</a>
   ...
   * It updates the device attribute configuration actually used by the device
   * but this method also updates the Tango database. One structure of the
   * AttributeConfig_3 type is needed for each attribute to update
   ...
   *
   * Invoked when the client request the read_attribute_history_5 CORBA
   ...
   * @return A DevAttrHistory_5 structure. This strucure contains all the
   * element allowing a client to retrieve for each history record the attribute
   * value, the date and in case of the attribute returns an error when it was
   * read, the DevErrors data. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#structs">here</a>
   * to read <b>DevAttrHistory</b> structure definition.
   * @exception DevFailed Thrown if the attribute does not exist or is not
   * polled. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#exceptions">here</a>
   * to read <b>DevFailed</b> exception specification
   */
   ...
   * @param cl_ident The client identificator. This parameter is new in
   * release 4. It allows device locking feature implemented in Tango V7
   * @return A DevPipeData structure. Click <a
   * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#structs">here</a>
   ...
   * It allows a client to send data to a device through a pipe then to read
   * data from the device through the same pipe.
   *
   * @param pipe_value The new pipe value
   * @param cl_ident The client identificator. This parameter is new in
   * release 4. It allows device locking feature implemented in Tango V7
