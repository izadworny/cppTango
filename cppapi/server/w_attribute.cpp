...
//
// description :
//		This method is used when a Writable attribute is set to set the value in
// the Attribute class. This is 		necessary for the read_attribute CORBA
// operation which takes its data from this internal Attribute 		class data. It
// is used in the read_attributes code in the device class
//
//--------------------------------------------------------------------------------------------------------------------
...
void WAttribute::check_written_value(const CORBA::Any &any, unsigned long x, unsigned long y)
{
  ...
  case Tango::DEV_ENUM:
  {
    ...
    if((any >>= sh_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarShortArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_LONG:
  {
    ...
    if((any >>= lg_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarLongArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_LONG64:
  {
    ...
    if((any >>= lg64_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarLong64Array (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_DOUBLE:
  {
    ...
    if((any >>= db_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarDoubleArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
...
#else
          if(std::isfinite((*db_ptr)[i]) == 0)
#endif
          {
            TangoSys_OMemStream o;

            o << "Set value for attribute " << name;
            o << " is a NaN or INF value (at least element " << i << ")" << std::ends;
            TANGO_THROW_EXCEPTION(API_WAttrOutsideLimit, o.str());
          }
        }
  ...
  case Tango::DEV_STRING:
    ...
    if((any >>= string_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarStringArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_FLOAT:
  {
    ...
    if((any >>= fl_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarFloatArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_USHORT:
  {
    ...
    if((any >>= ush_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarUShortArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_UCHAR:
  {
    ...
    if((any >>= uch_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarCharArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_ULONG:
  {
    ...
    if((any >>= ulo_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarULongArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_ULONG64:
  {
    ...
    if((any >>= ulg64_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarULong64Array (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_BOOLEAN:
    ...
    if((any >>= boo_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarBooleanArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
  ...
  case Tango::DEV_STATE:
  {
    ...
    if((any >>= sta_ptr) == false)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarStateArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
...
void WAttribute::check_written_value(const Tango::AttrValUnion &att_union, unsigned long x, unsigned long y)
{
  ...
  case Tango::DEV_ENUM:
  {
    ...
    //
    // If the attribute is enumerated, check the input value compared to the
    // enum labels
    //
    ...
    if(get_data_type() == DEV_ENUM)
    {
      ...
      for(i = 0; i < nb_data; i++)
      {
        if(sh_seq[i] < 0 || sh_seq[i] > max_val)
        {
          ...
          TANGO_THROW_EXCEPTION(API_WAttrOutsideLimit, ss.str());
        }
      }
    }
  }
  ...
  case Tango::DEV_ENCODED:
  {
    if(att_union._d() != ATT_ENCODED)
    {
      ...
      o << "Incompatible attribute type, expected type is : "
           "Tango::DevVarEncodedArray (even for single value)"
        << std::ends;
      TANGO_THROW_EXCEPTION(API_IncompatibleAttrDataType, o.str());
    }
...
//
// description :
//		Set the attribute internal value. There are different methods according to
// the attribute data type and
// the 		attribute type (scalar, spectrum or image)
//
//-------------------------------------------------------------------------------------------------------------------
...
{
  //
  // Dummy method just to make compiler happy when using
  // fill_attr_polling_buffer for DevEncoded attribute Should never be called
  //
...
void WAttribute::set_written_date() { write_date = make_timeval(std::chrono::system_clock::now()); }
...
bool WAttribute::check_rds_alarm()
{
  ...
  if(time_diff >= std::chrono::milliseconds(delta_t))
  {
    ...
    case Tango::DEV_SHORT:
      ...
      {
        short delta =
            (data_format == Tango::SCALAR) ? short_array_val[0] - tmp_sh[0] : short_array_val[i] - (*value.sh_seq)[i];
    ...
    case Tango::DEV_LONG:
      ...
      {
        DevLong delta =
            (data_format == Tango::SCALAR) ? long_array_val[0] - tmp_lo[0] : long_array_val[i] - (*value.lg_seq)[i];
    ...
    case Tango::DEV_DOUBLE:
      ...
      for(i = 0; i < nb_data; i++)
      {
        ...
        double delta =
            (data_format == Tango::SCALAR) ? double_array_val[0] - tmp_db[0] : double_array_val[i] - (*value.db_seq)[i];
    ...
    case Tango::DEV_FLOAT:
      ...
      for(i = 0; i < nb_data; i++)
      {
        ...
        float delta =
            (data_format == Tango::SCALAR) ? float_array_val[0] - tmp_fl[0] : float_array_val[i] - (*value.fl_seq)[i];
    ...
    case Tango::DEV_UCHAR:
      ...
      {
        unsigned char delta =
            (data_format == Tango::SCALAR) ? uchar_array_val[0] - tmp_cha[0] : uchar_array_val[i] - (*value.cha_seq)[i];
...
void WAttribute::set_min_value(char *new_min_value_str) { set_min_value(std::string(new_min_value_str)); }

void WAttribute::set_min_value(const char *new_min_value_str) { set_min_value(std::string(new_min_value_str)); }

void WAttribute::set_max_value(char *new_max_value_str) { set_max_value(std::string(new_max_value_str)); }

void WAttribute::set_max_value(const char *new_max_value_str) { set_max_value(std::string(new_max_value_str)); }
