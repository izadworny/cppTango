...
/**
 * This class is a class representing a writable pipe in the TANGO device server
 * pattern. It is an base class. It is the a root class for pipe related
 * classes.
 *
 *
 * @headerfile tango.h
...
//@{
   ...
   *
   * Extracting data from a WPipe instance is simlar to extracting data from a
   * DevicePipeBlob class instance. See doc of DevicePipeBlob class extraction
   * methods (DevicePipeBlob::operator>>) to get a complete documentation on how
   * to extract data from a WPipe
   *
