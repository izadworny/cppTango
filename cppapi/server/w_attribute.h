...
public:
   ...
   *
   * @param min_value Reference to a variable which value will be set to the
   ...
   *
   * @return check_max_value A boolean set to true if the attribute has a
   ...
   *
   * @param max_value Reference to a variable which value will be set to the
   ...
   * Tango::DevBoolean.
   *
   * @param val A reference to a Tango::DevBoolean data which will be
   * initialised with the new value
   */
   ...
   * Tango::DevULong64.
   *
   * @param val A reference to a Tango::DevULong64 data which will be
   * initialised with the new value
   */
   ...
   * Tango::DevEncoded.
   *
   * @param val A reference to a Tango::DevEncoded data which will be
   * initialised with the new value
   */
  ...
  void set_write_value(Tango::DevEncoded *, long x = 1,
                       long y = 0); // Dummy method for compiler
...
private:
  ...
  DevErrorList mem_exception; // Exception received at start-up in case writing
                              // the memorized att. failed
