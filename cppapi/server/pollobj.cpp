...
// file :               PollObj.cpp
//
// description :        C++ source code for the PollObj class. This class is
// used to store all data specific to one
//						polled object and which does not need to be stored in the ring
// buffer
//
// project :            TANGO
//
...
//
// description :
//		Three constructors for the PollObj class. The first one constructs a
// PollObj instance with the 		default polling ring depth. The second one
// create a PollObj instance with a specified polling ring depth
//
// argument :
//		in :
...
//
// description :
//		These methods insert a new element in the object ring buffer when its real
// data
//
// argument :
//		in :
...
//
// description :
//		This method insert a new element in the ring buffer when this element is
// an exception
//
// argument :
//		in :
...
//
// description :
//		This method returns the date stored with the most recent record in the
// ring buffer (as a double in Sec)
//
//-------------------------------------------------------------------------------------------------------------------

PollClock::time_point PollObj::get_last_insert_date_i() { return ring.get_last_insert_date(); }
...
//
// description :
//		This method returns the last data stored in ring for a polled command or
// throw an exception if the 		command failed when it was executed
//
//-------------------------------------------------------------------------------------------------------------------
...
//
// description :
//		This method returns the last data stored in ring for a polled attribute or
// throw an exception if the 		read attribuite operation failed when it was
// executed
//
//-------------------------------------------------------------------------------------------------------------------
